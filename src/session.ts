 ...
 */
export function presetOf(agent: AgentLike | undefined): string {
 ...
 */
export function memoryDisabled(agent: AgentLike | undefined, disabledPresets: readonly string[]): boolean {
