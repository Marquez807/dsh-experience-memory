...
if (-not (Test-Path $home_)) {
  ...
  $pkg = '{"name":"dsh-profile-t2ab","private":true,"dependencies":{"@marquez807/dsh-experience-memory":"link:REPO"},"dsh":{"profile":{"bundles":["@deepseek-ai/dsh-base","@deepseek-ai/dsh-headless","@marquez807/dsh-experience-memory"]}}}'
