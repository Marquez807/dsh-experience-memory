  ...
  $pkg = @'
{
  ...
  "private": true,
  "dependencies": { "@marquez807/dsh-experience-memory": "link:PLACEHOLDER_REPO" },
  "dsh": { "profile": { "bundles": ["@deepseek-ai/dsh-base", "@deepseek-ai/dsh-headless", "@marquez807/dsh-experience-memory"] } }
}
'@
