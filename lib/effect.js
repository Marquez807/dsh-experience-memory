 ...
 */
export function measureEffect(arms                                               )                    {
  const rate = (run           )         => (run.ran <= 0 ? 0 : run.pass / run.ran)
 ...
 */
export function measurable(measurement                   )          {
...
export function describeEffect(measurement                   )         {
 ...
 */
export function configureEffect(options                                                       )       {
...
export function effectWeight()         {
  return weight
}

/** Whether decision-loss retirement is on (read by `lifecycle.ts`). */
export function decisionLossRetirement()          {
  return retention
}
